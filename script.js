...
function searchRoom(roomNumber) {
  ...
  fetch(
    "https://script.google.com/macros/s/AKfycbwd9ZXZZ9smyywYK5FBCJPT9TWAQkCqoZ4PSUOBqLbmdZOsa_lK6yeb5th0ytEWf6DQ/exec?room=" +
      ...
      if (data.room) {
        ...
        resultElement.innerHTML = `
                ...
                <p style="margin-top: 10px;">
                    <small>
                        <em>
                            🐾 Come meet TaoTao, the super cute cat that everyone falls in love with at first sight. 
                            <a href="https://www.instagram.com/p/DKoBYixSmEb/" 
                            style="color: blue; text-decoration: underline; font-weight: bold;">
                            Click
                            </a> to meet TaoTao and you'll see why everyone's so smitten!
                        </em>
                    </small>
                </p>
            `;
